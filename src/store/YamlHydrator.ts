...
import { CUSTOM_FIELD_TYPES, DEPENDENCY_TYPES, DOC_STATES, makeDocument, makeTask, PRIORITY_ICON_SETS } from '../types'
  ...
  return raw
    ...
    .map((r) => {
      ...
      const validViewMode: ViewMode | undefined =
        viewMode === 'table' || viewMode === 'gantt' || viewMode === 'kanban' || viewMode === 'library'
          ? viewMode
          : undefined
      return {
        id: (v.id as string) ?? '',
