...
export function serializeProject(
  ...
  const fm: Record<string, unknown> = {
    ...
    // Written only when it is one: a project note gains no key by not being a programme.
    ...(project.program ? { [PROGRAM_FRONTMATTER_KEY]: true } : {}),
    ...(project.template ? { [TEMPLATE_FRONTMATTER_KEY]: true } : {}),
    id: project.id,
    title: project.title,
